...
#ifndef MAIN_SMARTHOME_LIB_FREERTOS_TIMERCPP_H_
#define MAIN_SMARTHOME_LIB_FREERTOS_TIMERCPP_H_


#define STARTTIMERONCE(timer, periodMs)	timer.Stop(100); \
										timer.SetPeriod(period, 100);\
										timer.Start(100)
...
#endif /* MAIN_SMARTHOME_LIB_FREERTOS_TIMERCPP_H_ */
